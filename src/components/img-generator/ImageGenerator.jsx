...
const ImageGenerator = () => {
  ...
  return (
    ...
    <div className="img-loading">
        <div className="image"><img src={image_url === "/"? AI_Image : image_url} alt="Generated" /></div>
    ...
    <div className="search-box">
        <input type="text" className='search-input' placeholder='Describe your image...' ref={inputRef} />
